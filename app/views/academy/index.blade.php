                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-6">
                        <p class="page-title"><i class="fa fa-table"></i> 
                            <span> Danh sách tin học viện</span>
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-2">
                        <a href="{{ URL::to('admin/academy/create') }}" class="btn btn-pink pull-right btn-create"><i class="fa fa-plus"></i> Tạo tin tức</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <a href="{{ URL::to('admin/cateacademy') }}" class="btn btn-pink pull-right btn-create"><i class="fa fa-table"></i> Danh mục tin học viện</a>
                    </div>
                </div>
                <div class="search-box">
                    {{ Form::open(array(
                        'url' => URL::to('/admin/academy'),
                        'class' => '',
                        'method' => 'get',
                    )) }}
                        ...
                        <tbody>
                            @foreach ($news as $new)
                                <tr>
                                    ...
                                    <td>
                                        @if ($new->is_deleted != 1) 
                                        <a href="{{ URL::to('/admin/academy/edit/'.$new->new_id) }}" class="btn btn-primary has-tooltip" title="Sửa"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ URL::to('/admin/academy/delete/'.$new->new_id) }}" 
