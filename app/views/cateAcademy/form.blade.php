...
<div class="" style="margin-top: 15px;">
    <div class="row" id="tab-vi">
        ...
        <div class="form-group col-sm-12">
            <label for="title">Tên danh mục <span class="required"> *</span></label>
            {{ Form::text('title', !empty($new) ? $new->name : null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group col-sm-12">
            <label for="content">Mô tả <span class="required"> *</span></label>
            {{ Form::textarea('summary', !empty($new) ? $new->summary : null, array('class' => 'form-control', 'id' => 'create-content-vi')) }}
        </div>
	    <div class="clear"></div>
    </div>
</div>
...
<div class="row direct-header">
    <div class="col col-sm-12">
        <button class="btn btn-primary" type="submit" style="margin: 15px 0;"> Lưu</button>
        <a href="{{ URL::to('/admin/cateacademy') }}" class="btn btn-default"> Hủy bỏ</a>
    </div>
</div>
