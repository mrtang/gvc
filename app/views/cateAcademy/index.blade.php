                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-7 col-md-6">
                        <p class="page-title"><i class="fa fa-table"></i> 
                            <span> Danh mục học viện</span>
                        </p>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6">
                        <a href="{{ URL::to('admin/cateacademy/create') }}" class="btn btn-pink pull-right btn-create"><i class="fa fa-plus"></i> Tạo danh mục</a>
                    </div>
                </div>
                <div class="search-box">
                    {{ Form::open(array(
                        'url' => URL::to('/admin/cateacademy'),
                        'class' => '',
                        'method' => 'get',
                    )) }}
                        ...
                        <tbody>
                            @foreach ($news as $new)
                                <tr>
                                    ...
                                    <td>
                                        @if ($new->is_deleted != 1) 
                                        <a href="{{ URL::to('/admin/cateacademy/edit/'.$new->id) }}" class="btn btn-primary has-tooltip" title="Sửa"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ URL::to('/admin/cateacademy/delete/'.$new->id) }}" 
