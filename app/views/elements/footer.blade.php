<footer>
	...
	<div class="widget-1 first footer-widget widget col-lg-4 col-md-4"><div class="title-wrapper"> <h3 class="widget-title"><i class="far fa-newspaper"></i> Latest Posts</h3><div class="clear"></div></div> 
    <ul class="latest-post-w">


      <li>
      	<a rel="bookmark" href="https://skywarriorthemes.com/crystalskull/rasutmagnamet/">
	      	<div class="latest_p_img">

										<img alt="img" src="https://skywarriorthemes.com/crystalskull/wp-content/uploads/2015/10/31-100x90.jpg">
										...
										<div class="carousel_rating" style="color: #e0043f">
        ...
        <div class="info">
        	...
        	<a href="https://skywarriorthemes.com/crystalskull/rasutmagnamet/" class="pw_maint">Mollis leo semper dictum ras ut magna met</a>
        	<div class="pop_desc">By&nbsp;
        	<a data-original-title="View all posts by admin" data-toggle="tooltip" href="https://skywarriorthemes.com/crystalskull/author/admin/">admin</a>
        	/ <small><i class="fa fa-calendar"></i> October 31, 2015</small></div>
      ...
      <li>
      	<a rel="bookmark" href="https://skywarriorthemes.com/crystalskull/magnaeuismod/">
	      	<div class="latest_p_img">

										<img alt="img" src="https://skywarriorthemes.com/crystalskull/wp-content/uploads/2015/10/30-100x90.jpg">
										...
										<div class="carousel_rating" style="color: #60d600">
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
        ...
        <div class="info">
        	...
        	<a href="https://skywarriorthemes.com/crystalskull/magnaeuismod/" class="pw_maint">Disque vel augue sit amet diam lobortis posuere</a>
        	<div class="pop_desc">By&nbsp;
        	<a data-original-title="View all posts by admin" data-toggle="tooltip" href="https://skywarriorthemes.com/crystalskull/author/admin/">admin</a>
        	/ <small><i class="fa fa-calendar"></i> October 31, 2015</small></div>
      ...
      <li>
      	<a rel="bookmark" href="https://skywarriorthemes.com/crystalskull/muaoreetereharet/">
	      	<div class="latest_p_img">

										<img alt="img" src="https://skywarriorthemes.com/crystalskull/wp-content/uploads/2015/10/29-100x90.jpg">
										...
										<div class="carousel_rating" style="color: #d32f2f">
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
						<i class="fas fa-star"></i>
        ...
        <div class="info">
        	...
        	<a href="https://skywarriorthemes.com/crystalskull/muaoreetereharet/" class="pw_maint">Aenean sed interdum quammus laoreet posuere pharet</a>
        	<div class="pop_desc">By&nbsp;
        	<a data-original-title="View all posts by admin" data-toggle="tooltip" href="https://skywarriorthemes.com/crystalskull/author/admin/">admin</a>
        	/ <small><i class="fa fa-calendar"></i> October 31, 2015</small></div>
      ...
      <li>
      	<a rel="bookmark" href="https://skywarriorthemes.com/crystalskull/enasqurtor/">
	      	<div class="latest_p_img">

										<img alt="img" src="https://skywarriorthemes.com/crystalskull/wp-content/uploads/2015/10/28-100x90.jpg">
        ...
        <div class="info">
        	...
        	<a href="https://skywarriorthemes.com/crystalskull/enasqurtor/" class="pw_maint">Denas ut erat scelerisque tortor etnubus artoreas</a>
        	<div class="pop_desc">By&nbsp;
        	<a data-original-title="View all posts by admin" data-toggle="tooltip" href="https://skywarriorthemes.com/crystalskull/author/admin/">admin</a>
        	/ <small><i class="fa fa-calendar"></i> October 31, 2015</small></div>
	...
	<div class="widget-2 footer-widget widget col-lg-4 col-md-4"><div class="title-wrapper"> <h3 class="widget-title"><i class="far fa-newspaper"></i> Popular Posts</h3><div class="clear"></div></div> 
    <ul class="review">
...
<i class="far fa-calendar-alt"></i> June 17, 2013</small>
		...
		<div class="clear"></div>
              ...
              </div>        <div class="widget-3 last footer-widget widget col-lg-4 col-md-4"><div class="title-wrapper"><h3 class="widget-title">Instagram</h3><div class="clear"></div></div>
